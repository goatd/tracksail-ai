 ...
 * each buoy. The buoys can move, e.g. when hit by a goat. A buoy that has moved
...
public class Port
{
	...
	{
		// If the buoy is too close to the goat, move the buoy away from
		// the goat.
	 ...
	 * the goat) intersects with this gate while going to the allowed
	 * direction.
	 * 
