        ...
        public String processInput(String input)
        {
            ...
            if (type.equalsIgnoreCase("set"))
            {
                ...
                else if (command.equalsIgnoreCase("sail"))
                {
                    ...
                    try
                    {          
                        //get desired sail direction in terms against the goat
                        ...
                        //change coords to normal goat like ones, from robot like ones
            ...
            else if (type.equalsIgnoreCase("get"))
            {
                ...
                if (command.equalsIgnoreCase("wind_dir"))
                {
                    ...
                    //needs to be relative to goat
                    int angle = player.getGame().getWindDirection();

                    //make relative to the goat
