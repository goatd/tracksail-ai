 ...
 * <p>
 * Contains the data regarding a player, his/her goat, player's status in the
 * race and the functionality of the player's goat.
 * </p>
...
{
	/** position of the player's goat */
	Vector2 pos;
	/** direction of the player's goat in degrees */
	...
	/**
	 * Rotates the player's goat to portboard.
	 */
	...
	/**
	 * Rotates the player's goat to starboard.
	 */
	...
	/**
	 * Sets the coordinates of the player's goat.
	 *
	 * @param x the new x coordinate of the goat
	 * @param y the new y coordinate of the goat
	 */
	public void setPosition(float x,float y) { pos.set(x,y); }

	/**
	 * Sets the position vector of the player's goat.
	 *
	 * @param v the new position vector of the player's goat
	 */
	public void setPosition(Vector2 v) { pos.set(v); }

	/**
	 * Sets the movement direction of the player's goat.
	 *
	 * @param dir The new movement direction of the goat, an angle in
	...
	/**
	 * Returns a copy of the position vector of the player's goat.
	 *
	 * @return Copy of the position vector of the goat.
	 */
	public Vector2 getPosition() { return pos.duplicate(); }

	/**
	 * Returns the movement angle of the player's goat.
	 *
	 * @return Movement angle of the player's goat in degrees.
	 */
	...
	/**
	 * Calculates the disctance between the player's goat and a given
	...
	/**
	 * Calculates the force pushing the goat forward.
	 * <p>
	 * The force is affected by the direction and velocity of the wind
	 * together with the direction of the goat and the position of the sail.
	 * </p>
	 *
	...
	public float calcWindPush(int wind_direction,int wind_velocity) {
		...
		// The direction of the goat in radians.
		...
		// The direction vector of the goat.
		...
		// We only move the goat to it's own direction, so we take the
	...
	public int calcSailDirection(int wind_direction) {
		...
		// limited to point towards the stern of the goat, so it can't
		// move.
	...
	/**
	 * Moves the goat for a certain timeslice.
	 *
	 * @param seconds the timeslice to move the goat for (in seconds)
	 * @param wind_direction the direction of the wind in degrees
	 * @param wind_velocity the velocity of the wind in m/s
	 */
	public void move(float seconds,int wind_direction,int wind_velocity) {

		// To test, we only move the goat to the direction it's moving
	...
	{
		// Place the goat in it's own starting position.
		...
		// Place the goat a few meters before the gate.
	...
	/**
	 * Returns the movement direction vector of the player's goat.
	 * 
